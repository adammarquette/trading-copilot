...
| [#194](https://github.com/adammarquette/trading-copilot/issues/194) | EOD settlement reconcile (venue-as-truth, settlement re-mark, window awareness, declare-unknown) | `SettlementReconcileIntegrationTests.cs` (+ `TestHost/SettlementTestPostgresFactory.cs`) | ✅ Delivered (this PR) |
