...
| [#281](https://github.com/adammarquette/trading-copilot/issues/281) | Account-event ingestion (fill → journal, PartiallyFilled/Filled, terminal states) | `AccountEventIngestionIntegrationTests.cs` | ✅ Delivered (this PR) — QA for gh#219 |
