...
| [#188](https://github.com/adammarquette/trading-copilot/issues/188) | Redundant watchdog + rejected-order | `AutoFlattenWatchdogIntegrationTests.cs` | ✅ Delivered (this PR) |
